 ...
 * Standalone version with inline functions
 */

import chalk from 'chalk';

// Inline implementation of detectIncrementalPRD
function detectIncrementalPRD(prdContent) {
...
// Inline implementation of summarizeTasksForContext
function summarizeTasksForContext(tasks) {
